...
save(smc024.merged,file='03smc024.merged_sct_mt15_nF7000.Rdata')
...
write.table(smc024.markers,file="02DEG_SCTcluster0-21_mt30_rna7000_rmMT.txt",row.names = F,sep="\t")
...
VlnPlot(smc024.merged, features=c("CD44","VIM"), y.max=4, same.y.lims=TRUE)
FeaturePlot(smc024.merged, features = c("CD44","VIM"))

DoHeatmap(smc024.merged, features = c("CD44","VIM"), slot="data")
